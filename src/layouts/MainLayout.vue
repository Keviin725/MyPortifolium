<template>
  <q-layout view="hHh lpr lff">
    ...
    <div class="layout">
      ...
      @item-click="handleItemClick(index, $event)"
    />
      </div>
    </div>
...
.layout {
  display: flex;
  flex-direction: row;
  height: 100vh; /* Ajuste com base na altura do cabeçalho */
  position: relative;
}
...
.q-footer {
  ...
  left: 0;
  right: 0;
  /* Garante que o rodapé não sobreponha conteúdo importante */
}
