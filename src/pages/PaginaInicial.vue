...
.intro-section {
  ...
  margin-bottom: 2em;
  position: relative; /* Garante que a posição dos elementos filhos seja relativa à seção */
}
...
.intro-image {
  ...
  height: 300px; /* Garante que a altura seja a mesma que a largura */
  display: flex;
  align-items: center;
